        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KycStatus = table.Column<string>(type: "varchar(20)", nullable: false),
                    KycAttemptCount = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
                    Role = table.Column<string>(type: "varchar(10)", nullable: false),
                    AdminRole = table.Column<string>(type: "varchar(20)", nullable: false),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                    LoginFailCount = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
                    IsLocked = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    LockoutToken = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    LockoutTokenExpiresAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserExternalLogins_Provider_ExternalId",
